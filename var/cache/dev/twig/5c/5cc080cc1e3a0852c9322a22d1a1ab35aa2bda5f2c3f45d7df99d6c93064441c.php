...
class __TwigTemplate_bfd5cdc52c7c7df0709d8425accf02e566833a844356d0201cdc4ab2d503cfcc extends \Twig\Template
{
  ...
  <div class=\"row\">
    ...
    <div class=\"row justify-content-center\">
      <div class=\"col\">
        ";
        // line 63
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock(($context["form"] ?? $this->getContext($context, "form")), 'form_start', ["action" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_webservice_save_settings"), "attr" => ["class" => "form", "id" => "configuration_form"]]);
        echo "
...
{% block content %}
  ...
  <div class=\"row\">
    ...
    <div class=\"row justify-content-center\">
      <div class=\"col\">
        {{ form_start(form, {'action': path('admin_webservice_save_settings') ,'attr' : {'class': 'form', 'id': 'configuration_form'} }) }}
...
{% endblock %}
", "@PrestaShop/Admin/Configure/AdvancedParameters/Webservice/index.html.twig", "C:\\laragon\\www\\prestashop\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Configure\\AdvancedParameters\\Webservice\\index.html.twig");
    }
}
