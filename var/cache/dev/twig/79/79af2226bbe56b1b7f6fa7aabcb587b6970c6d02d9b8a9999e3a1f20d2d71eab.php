...
class __TwigTemplate_0d2d0cca06c4f19fb73d1f57b43f728b4192e7550717f1039acca050a94b4605 extends \Twig\Template
{
    ...
    <div class=\"card-block row\">
      <div class=\"card-text\">
        <div class=\"form-group row\">
          <label for=\"";
        // line 36
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["employeeOptionsForm"] ?? $this->getContext($context, "employeeOptionsForm")), "options", []), "password_change_time", []), "vars", []), "id", []), "html", null, true);
        ...
        echo "
          ...
          <div class=\"col-sm\">
            ";
        // line 41
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute($this->getAttribute(($context["employeeOptionsForm"] ?? $this->getContext($context, "employeeOptionsForm")), "options", []), "password_change_time", []), 'errors');
        echo "
            ";
        // line 42
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute($this->getAttribute(($context["employeeOptionsForm"] ?? $this->getContext($context, "employeeOptionsForm")), "options", []), "password_change_time", []), 'widget');
        echo "
        ...
        <div class=\"form-group row\">
          <label for=\"";
        // line 58
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["employeeOptionsForm"] ?? $this->getContext($context, "employeeOptionsForm")), "options", []), "allow_employee_specific_language", []), "vars", []), "id", []), "html", null, true);
        echo "\" class=\"form-control-label\">
            ";
        // line 59
        ...
        echo "
          ...
          <div class=\"col-sm\">
            ";
        // line 63
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute($this->getAttribute(($context["employeeOptionsForm"] ?? $this->getContext($context, "employeeOptionsForm")), "options", []), "allow_employee_specific_language", []), 'errors');
        echo "
            ";
        // line 64
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute($this->getAttribute(($context["employeeOptionsForm"] ?? $this->getContext($context, "employeeOptionsForm")), "options", []), "allow_employee_specific_language", []), 'widget');
        echo "
            <small class=\"form-text\">
              ";
        // line 66
...
{% block employee_options_form %}
  ...
  <div class=\"card\">
    ...
    <div class=\"card-block row\">
      <div class=\"card-text\">
        <div class=\"form-group row\">
          <label for=\"{{ employeeOptionsForm.options.password_change_time.vars.id }}\" class=\"form-control-label\">
        ...
        <div class=\"form-group row\">
          <label for=\"{{ employeeOptionsForm.options.allow_employee_specific_language.vars.id }}\" class=\"form-control-label\">
...
{% endblock %}
", "@PrestaShop/Admin/Configure/AdvancedParameters/Employee/Blocks/employee_options.html.twig", "C:\\laragon\\www\\prestashop\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Configure\\AdvancedParameters\\Employee\\Blocks\\employee_options.html.twig");
    }
}
